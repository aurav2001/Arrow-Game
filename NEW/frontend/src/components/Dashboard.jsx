...
import { LogOut, Trophy, Play, Video, Star, Lock } from 'lucide-react';
      ...
      <div className="welcome-banner glass-panel">
        <div className="welcome-info">
          ...
          <div className="stats-grid">
            ...
            <div className="stat-card">
              <div className="stat-value">{levelsCompleted}</div>
              <div className="stat-label">Completed</div>
            </div>
            <div className="stat-card">
              <div className="stat-value" style={{ color: 'var(--neon-yellow)' }}>{totalStars}</div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
          ...
          <button className="btn" onClick={onToggleCreatorMode}>
            <Video size={18} style={{ color: 'var(--neon-pink)' }} />
            Creator Mode
          </button>
